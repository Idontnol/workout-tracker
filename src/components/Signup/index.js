...
const Signup=()=>{
  ...
  const getErrorMessage = (error) => {
    ...
    return errorMap[error.code] || 'An error occurred at signup. Please check details carefully.';
  };
    ...
    return(
        <div className=''>
            ...
            <p className=''>or</p>
            <button onClick={handleGoogleLogin} className='socialmedia-btn google-extra'>
